<template>
  <van-popup v-model="status.speopleListPopup" position="right" style="width:100%;height:100%;">
    <van-nav-bar :title="status.speopleListTitle" @click-left="onClickLeft" left-text="返回" />
